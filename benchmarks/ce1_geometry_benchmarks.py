...
class MirrorPhaseClassificationBenchmark:
    ...
    def __init__(self):
        self.config = BenchmarkConfig(
            ...
            scale=50000,  # Large scale to prevent memorization
            diversity_factors=[
    ...
    def generate_dataset(self, size: int) -> Tuple[List[CE1GeometryPoint], List[int]]:
...
class CurvatureFieldRegressionBenchmark:
    ...
    def generate_dataset(self, size: int) -> Tuple[List[CE1GeometryPoint], List[float]]:
