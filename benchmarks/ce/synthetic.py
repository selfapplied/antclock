...
from ..definitions import BenchmarkSuite, BenchmarkResult
from .ce1 import ce1_benchmarks
from .ce2 import ce2_benchmarks
from .ce3 import ce3_benchmarks
...
def main():
    """Run the complete CE benchmark suite with enhanced progress indication."""
    print("🔬 CE BENCHMARK SUITE - ENHANCED PROGRESS TRACKING")
    print("=" * 60)
    print("Features:")
    print("  📊 Real-time progress bars with generation rates")
    print("  ⏱️  Time estimates and ETA calculations")
    print("  💾 Memory usage monitoring")
    print("  🎯 Detailed benchmark status updates")
    print("=" * 60)
    ...
    # Force cleanup before printing to avoid memory issues
    import gc
    gc.collect()

    # Print enhanced summary
    print("\n🎉 CE BENCHMARK SUITE COMPLETED SUCCESSFULLY!")
    print("=" * 60)
    print("📈 Performance Highlights:")
    print(f"   • Total benchmarks: {len(results)}")
    print(f"   • Results saved to: {runner.output_dir}/")
    print(f"   • Mathematical consistency: {sum(r.mathematical_consistency for r in results.values())/len(results):.3f}")
    print("   • All CE layers validated")
    print("=" * 60)
...
__all__ = ['main', 'CEBenchmarkRunner']
